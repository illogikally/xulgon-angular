...
@Component({
  selector: 'app-avatar-cover-changer',
  templateUrl: './avatar-cover-changer.component.html',
  styleUrls: ['./avatar-cover-changer.component.scss']
})
export class AvatarCoverChangerComponent implements OnInit {
